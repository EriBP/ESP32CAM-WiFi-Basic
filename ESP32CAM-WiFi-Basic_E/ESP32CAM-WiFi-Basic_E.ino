...
// Datos de Red
const char* ssid = "INFINITUMB09C_2.4";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "mz7srSbma6";  // Escribe la contraseña de dicha red
